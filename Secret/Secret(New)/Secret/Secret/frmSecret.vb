...
#Region "frmSecret Modules"
    ...
    Private Sub Secret_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        End With
        ' My.Computer.FileSystem.WriteAllText(My.Computer.FileSystem.SpecialDirectories.Desktop & "\hgy.txt", lblTime.Location.ToString & vbCrLf & lblDate.Location.ToString, True)
                    ...
                    Select Case j
                        ...
                        Case 4
                            Select Case i
                                Case Is < Len(Msg2)
                                    bc = False
                                    Me.lblSecret.Text = Mid(Msg2, 1, i) & "|"
                                    i += 1
                                Case Len(Msg2)
                                    Select Case k
                                        Case Is < 14
                                        ...
                                        Case 14
                                            Select Case i2
                                                Case Is < Len(Msg3)
                                                    bc = False
                                                    Me.lblSecret.Text = Msg2 & vbCrLf & Mid(Msg3, 1, i2) & "|"
                                                    i2 += 1
                                                Case Len(Msg3)
                                                    Select Case l
                                                        Case Is < 70
                                                        ...
                                                        Case 70
                                                            Select Case i3
                                                                Case Is < Len(Msg4)
                                                                    bc = False
                                                                    Me.lblSecret.Text = Msg2 & vbCrLf & Msg3 & vbCrLf & Mid(Msg4, 1, i3) & "|"
                                                                    i3 += 1
                                                                Case Len(Msg4)
                                                                    Select Case m
                                                                        Case Is < 14
